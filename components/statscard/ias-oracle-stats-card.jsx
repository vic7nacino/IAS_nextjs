...
import { useState } from 'react'
  ...
  export default function IasOracleStatsCard({ iasOraStatData }) {
    console.log(iasOraStatData)
    const [ newdata, setNewData ] = useState(iasOraStatData.newData)
    const [ closedData, setClosedData] = useState(iasOraStatData.closedData)
    return (
